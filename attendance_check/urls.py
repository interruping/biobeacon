...
urlpatterns = [
    ...
    url(r'^api/lecture/beacon/uuid/$', LectureGetUUID.as_view()),
    url(r'^api/lecture/apply/stop/$', LectureStopView.as_view()),
    url(r'^api/lecture/request/attendance/', LectureRequestAttendance.as_view()),
]
